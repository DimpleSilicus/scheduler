 ...
 */
class BankDetailsTemp extends Model
{
   
    protected $primaryKey = 'id';

    protected $table = 'bank_details_temp';
...
//    protected $dates = ['deleted_at'];
    ...
    {
        $success=DB::table('bank_details_temp')->truncate();
        return $success;
    }
