...
use Modules\Federal\Model\BankDetails;
use Modules\Federal\Model\BankDetailsTemp;
...
class FederalController extends Controller
{
    ...
    */
    ...
    /**
     * Function is to get data from URL, Dump to temp table and then to live table after checking some conditions.
     *
     * @name cronjob
     * @access public
     * @author Dimple Agarwal <dimple.agarwal@silicus.com>
